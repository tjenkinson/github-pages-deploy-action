    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!util_2.isNullOrUndefined(constants_1.action.deployKey)) {
                ...
                yield createFile(`${constants_1.ssh}/known_hosts`, '', {
                    mode: 0o400,
                    flag: 'ax'
                });
                yield execute_1.execute(`ssh-keyscan -t rsa github.com > "known_hosts"`, constants_1.ssh);
                yield execute_1.execute(`chmod 400 id_rsa`, constants_1.ssh);
                yield execute_1.execute(`ssh-add -K ${constants_1.ssh}/id_rsa`, constants_1.workspace);
            }
