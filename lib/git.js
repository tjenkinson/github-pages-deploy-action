    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (action.clearHistory) {
                yield execute_1.execute(`git push ${action.repositoryPath} 'git subtree split --prefix ${temporaryDeploymentDirectory} ${temporaryDeploymentBranch}':${action.branch} --force`, `${action.workspace}/${temporaryDeploymentDirectory}`);
            }
            else {
