    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (action.clearHistory) {
                yield execute_1.execute(`git subtree push --prefix ${temporaryDeploymentDirectory} ${temporaryDeploymentBranch} ${action.branch}`, `${action.workspace}/${temporaryDeploymentDirectory}`);
            }
            else {
