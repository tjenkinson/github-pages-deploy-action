    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                yield execute_1.execute(`git fetch ${action.repositoryPath} --no-recurse-submodules`, action.workspace, action.silent);
                core_1.info('Git configured… 🔧');
            }
            catch (_a) {
                throw new Error(`There was an issue establishing your workflow. Please refer to the README and ensure you're running @actions/checkout prior to this step: https://github.com/JamesIves/github-pages-deploy-action/blob/dev/README.md`);
            }
        }
        catch (error) {
