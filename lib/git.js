    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (action.clearHistory) {
                yield execute_1.execute(`git push --force ${action.repositoryPath} \`git subtree split --prefix ${temporaryDeploymentDirectory} ${action.baseBranch}\`:${action.branch}`, `${action.workspace}/${temporaryDeploymentDirectory}`);
            }
            else {
