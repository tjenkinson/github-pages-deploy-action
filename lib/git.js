    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!util_1.isNullOrUndefined(constants_1.action.deployKey)) {
                ...
                yield execute_1.execute(`ssh-keyscan github.com >> known_hosts`, constants_1.ssh);
                yield execute_1.execute(`echo "${constants_1.action.deployKey}" > "id_rsa"`, constants_1.ssh);
                yield execute_1.execute(`echo "id_rsa" | wc -c`, constants_1.ssh);
                yield execute_1.execute(`ls`, constants_1.ssh);
                yield execute_1.execute(`ssh -T git@github.com`, constants_1.ssh);
            }
