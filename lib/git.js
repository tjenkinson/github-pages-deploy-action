    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (action.clearHistory) {
                yield execute_1.execute(`git reset $(git merge-base ${action.baseBranch} ${temporaryDeploymentBranch})`, `${action.workspace}/${temporaryDeploymentDirectory}`);
            }
            // Commits to GitHub.
            ...
            yield execute_1.execute(`git push ${action.repositoryPath} ${temporaryDeploymentBranch}:${action.branch}`, `${action.workspace}/${temporaryDeploymentDirectory}`);
